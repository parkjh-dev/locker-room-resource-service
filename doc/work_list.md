...
## Phase 12: 웹 서비스 정합성 보완

> 점검 일시: 2026-02-25
> 대상: `locker-room-web-service`와의 API/DTO 불일치 해소
> 참조: 웹 서비스 `work_list.md` Phase 21과 병행 작업

### 12.1 [Critical] 누락 엔드포인트 구현
...
- [x] `AuthorInfo`에 `teamName` 필드 추가
  ...
  - `PostMapper`, `CommentMapper`에서 User → AuthorInfo 변환 시 대표 팀명 주입
